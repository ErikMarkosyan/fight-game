...
import { subRanger, RangerOne, RangerTwo } from 'src/utils';
...
export class AppComponent {
  ...
  rangerOne: subRanger | undefined = undefined;
  rangerTwo: subRanger | undefined = undefined;
  intervalId: any;
  ...
  activateRangerOne() {
    this.rangerOne = new RangerOne('Ranger 1', 100);
  ...
  activateRangerTwo() {
    this.rangerTwo = new RangerTwo('Ranger 2', 100);
